...
namespace WebDriver_example_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            driver.FindElement(By.XPath("/html/body/div[2]/div/div[1]/div/div[1]/a[2]")).Click();
            driver.FindElement(By.XPath("/html/body/div[2]/div/div[2]/div/div/div[1]/div/a/div[1]/h4")).Click();
